...
export default function StudentLobbyList() {
    ...
    >
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <div>
                ...
                <p className="text-blue-600 font-medium">Mission Selection</p>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <div className="px-6 py-8">
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div className="px-10" variants={containerVariants}>
            {lobbies.length === 0 ? (
                      ...
                      >
                        ...
                        >
                          ...
                          <p className="text-gray-600 text-sm">
                            ...
                            knowledge and decision-making skills under pressure.
                          </p>
                        </motion.div>
                        ...
                        <motion.button
                          ...
                          whileHover={
                            isJoining !== lobby.id ? { scale: 1.02 } : {}
                          }
                          whileTap={
                            isJoining !== lobby.id ? { scale: 0.98 } : {}
                          }
                          initial={{ y: 20, opacity: 0 }}
                          animate={{ y: 0, opacity: 1 }}
                    ...
                    >
                      {lobbies
                        ...
                        .map((lobby, index) => (
                          <motion.div
                            key={lobby.id}
                            className="bg-gray-50 border-2 border-gray-200 rounded-2xl p-6 shadow-lg opacity-75"
                            variants={cardVariants}
                            layout
                            custom={index}
                          >
                            ...
                            >
                              <div className="flex items-center gap-4">
                                <div className="p-3 bg-gray-200 rounded-full border-2 border-gray-300">
                                ...
                                <div>
                                  ...
                                  <p className="text-gray-400 text-xs">
                                    Mission ID:{" "}
                                    {lobby.id.slice(-8).toUpperCase()}
                                  </p>
                                </div>
                              </div>

                              <div className="px-3 py-1 bg-green-100 text-green-700 border border-green-300 rounded-full text-xs font-semibold">
                                COMPLETED
                              </div>
                            </motion.div>

                            <button
                              className="w-full py-4 px-6 rounded-xl font-semibold flex items-center justify-center gap-3 border-2 bg-gray-200 text-gray-500 border-gray-300 cursor-not-allowed"
                              disabled
                            >
