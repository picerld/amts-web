...
import { InstructorUpdateFormOuter } from "../update/InstructorUpdateFormOuter";

export function InstructorDatatable() {
  ...
  const { data, isLoading, refetch } = trpc.users.getPaginatedInstructor.useQuery(
    {
      page,
      perPage,
