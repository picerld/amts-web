      ...
      <div className="flex flex-col gap-6 w-full h-screen">
        ...
        <div className="flex justify-between w-full">
          <Card className="w-[350px]">
            <CardTitle className="px-5 text-xl">Overview</CardTitle>
            <CardContent className="text-lg">10</CardContent>
          </Card>

          <div className="flex gap-3">
            <Card className="w-[250px]">
              <CardTitle className="px-5 text-xl">Total Soal</CardTitle>
              <CardContent className="text-lg">10</CardContent>
            </Card>
            <Card className="w-[250px]">
              <CardTitle className="px-5 text-xl">Total Peserta</CardTitle>
